...
from tests.routes_test import URL_channel_list, URL_channels_create

def test_ACCESS_ERROR_invalid_token(first_user_flask, first_channel_public_flask):
    response = requests.get(URL_channel_list,
...
def test_VALID_STATUS_many_channel(first_user_flask):
